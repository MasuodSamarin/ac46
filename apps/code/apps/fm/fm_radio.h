...
#define FM_DAC_TASK_NAME   "FMsrcTask"
...
extern void fm_hw_init(void);       ///>FM硬件初始化

extern void set_fm_printf(u8);
extern void set_fm_osc(u32 osc_fre);
extern s16 get_cur_fre_info(void);
...
*/
/*----------------------------------------------------------------------------*/
extern void set_fm_scan(u8 nrs, u8 nc1, u8 nc2, u8 ncc,u8 fmif_g);
