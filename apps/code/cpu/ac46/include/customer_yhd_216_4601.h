...
//key msg 
#define  adk_user_6_key_mode_3      //长按PP 为灯控
 
// 频谱显示
#define support_led_eq_disp    //支持发光管频谱显示
#define support_led_eq_user_PA15PA14PA11PA10
#define support_led_eq_is_4led_user_sw    //六个灯无开关模式 
...
#if KEY_IR_EN 
    #define   Ir_user_pa5
    #define IR_USER_KPL_003    //IR_USER_KPL_001
...
#define support_one_call_key


#define OFF_BPF_BT_MP3     //关蓝牙模式提示音
#define support_SHORT_CALL_Twice_CALL_LAST_NO //port_SHORT_PPKEY_Twice_CALL_LAST_NO
