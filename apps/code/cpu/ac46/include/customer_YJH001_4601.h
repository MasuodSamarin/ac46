...
#if KEY_IO_EN
    #define support_io_scan_key_user_PA5_PA6_PA7_PA8_PA9_PA10
    #define support_yjh_001io_scan_mode
#endif   
...
//key msg 
#define  adk_user_3_4_6_key_mode   //    3 4 6 通用    
...
//开机 默认模式  
  #define power_on_no_usb_sd_to_bt   //无设备到蓝牙
