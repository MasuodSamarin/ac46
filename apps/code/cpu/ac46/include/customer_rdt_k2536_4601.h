...
//key msg 
#define  adk_user_3_4_6_key_mode   
...
#define  PP_LED_USER_PA8

// 频谱显示
#define support_led_eq_disp    //支持发光管频谱显示
#define support_led_eq_user_PA15PB6PB7PB8PB9PB10
#define support_led_eq_is_6led_no_sw    //六个灯无开关模式 
#define support_rdt_2536_mode
