...
#define AMUX_BIAS_EN(x)     DAA_CON2 = ((DAA_CON2 & ~BIT(12)) | ((x & 0x1)<<12))
...
/*---DAA_CON3 sfr Setting----*/
#define MIC_GAIN(x)         DAA_CON3 = ((DAA_CON3 & ~(BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5))) | (x & 0x3f))
#define MIC_GX2_EN(x)       DAA_CON3 = ((DAA_CON3 & ~BIT(6)) | ((x & 0x1)<<6))
#define MIC_MUTE_EN(x)      DAA_CON3 = ((DAA_CON3 & ~BIT(7)) | ((x & 0x1)<<7))
#define LIN0L_BIAS_EN(x)    DAA_CON3 = ((DAA_CON3 & ~BIT(8)) | ((x & 0x1)<<8))
#define LIN0R_BIAS_EN(x)    DAA_CON3 = ((DAA_CON3 & ~BIT(7)) | ((x & 0x1)<<9))
#define LIN1L_BIAS_EN(x)    DAA_CON3 = ((DAA_CON3 & ~BIT(10)) | ((x & 0x1)<<10))
#define LIN1R_BIAS_EN(x)    DAA_CON3 = ((DAA_CON3 & ~BIT(11)) | ((x & 0x1)<<11))
#define LIN2L_BIAS_EN(x)    DAA_CON3 = ((DAA_CON3 & ~BIT(12)) | ((x & 0x1)<<12))
#define LIN2R_BIAS_EN(x)    DAA_CON3 = ((DAA_CON3 & ~BIT(13)) | ((x & 0x1)<<13))
#define MIC_EN(x)           DAA_CON3 = ((DAA_CON3 & ~BIT(14)) | ((x & 0x1)<<14))
