...
#define       IRC_FM_SCAN				22/*22*/
#define       IRC_AUX                               23 /*23*/
#define       IRC_FM				       24/*24*/
#define       IRC_FOLDER_NEXT			25/*25*/
#define       IRC_RECORD				26/*26*/
#define       IRC_REC_PLAY				27/*27*/
