...
//........ 0x080 - 0x0bf........
#define SPI2_CON                (*(volatile unsigned long  *)(hs_base + 0x20*4))    //
#define SPI2_BAUD               (*(volatile unsigned char  *)(hs_base + 0x21*4))    // Write only
//
#define SPI2_BASE_ADR           (*(volatile unsigned long  *)(hs_base + 0x23*4))    // Write only
...
//........ 0x180 - 0x1bf........
#define ALNK_CON0               (*(volatile unsigned short *)(ls_base + 0x60*4))    //
#define ALNK_CON1               (*(volatile unsigned short *)(ls_base + 0x61*4))    //
#define ALNK_CON2               (*(volatile unsigned short *)(ls_base + 0x62*4))    //
#define ALNK_ADR0               (*(volatile unsigned long  *)(ls_base + 0x63*4))    // Write Only
#define ALNK_ADR1               (*(volatile unsigned long  *)(ls_base + 0x64*4))    // Write Only
#define ALNK_ADR2               (*(volatile unsigned long  *)(ls_base + 0x65*4))    // Write Only
#define ALNK_ADR3               (*(volatile unsigned long  *)(ls_base + 0x66*4))    // Write Only
...
#define IRTC_BUF                (*(volatile unsigned char  *)(ls_base + 0x7f*4))    //
...
#define NFC_BUF0                (*(volatile unsigned long  *)(ls_base + 0x83*4))    //
#define NFC_BUF1                (*(volatile unsigned long  *)(ls_base + 0x84*4))    //
#define NFC_BUF2                (*(volatile unsigned long  *)(ls_base + 0x85*4))    // Write Only
#define NFC_BUF3                (*(volatile unsigned long  *)(ls_base + 0x86*4))    // Write Only
//
#define IOMC2                   (*(volatile unsigned long  *)(ls_base + 0x8a*4))    //
#define IOMC3                   (*(volatile unsigned short *)(ls_base + 0x8b*4))    //
#define PL_CNT_CON              (*(volatile unsigned char  *)(ls_base + 0x8c*4))    //
#define PL_CNT_VAL              (*(volatile unsigned short *)(ls_base + 0x8d*4))    //
...
#define CLK_CON1                (*(volatile unsigned short *)(ls_base + 0xa2*4))    //
...
#define HTC_CON                 (*(volatile unsigned short *)(ls_base + 0xaa*4))    //
#define LVD_CON                 (*(volatile unsigned char  *)(ls_base + 0xab*4))    //
#define MODE_CON                (*(volatile unsigned char  *)(ls_base + 0xac*4))    //
//

//........ 0x2c0 - 0x2ff........
#define DAA_CON0                (*(volatile unsigned short *)(ls_base + 0xb0*4))    //
#define DAA_CON1                (*(volatile unsigned short *)(ls_base + 0xb1*4))    //
#define DAA_CON2                (*(volatile unsigned short *)(ls_base + 0xb2*4))    //
#define DAA_CON3                (*(volatile unsigned short *)(ls_base + 0xb3*4))    //
...
#define  FMA_CON5               (*(volatile unsigned long  *)(FM_BASE_ADDR + 24*4))
#define  FMA_CON6               (*(volatile unsigned long  *)(FM_BASE_ADDR + 25*4))
#define  FMA_CON7               (*(volatile unsigned long  *)(FM_BASE_ADDR + 26*4))
#define  FMA_CON8               (*(volatile unsigned long  *)(FM_BASE_ADDR + 27*4))
